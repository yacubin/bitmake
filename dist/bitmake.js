...
class ProjectContext {
    ...
    getTarget(variableMap, name) {
        const impl = this[TARGET_COLLECTION].getOrCreate(name);
        return _core_Target__WEBPACK_IMPORTED_MODULE_13__.UserIndirectTarget.create(impl, variableMap, name);
    }
