...
/* harmony import */ var _core_BuiltinScripts__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @/core/BuiltinScripts */ "./src/core/BuiltinScripts/index.ts");
/*
 * MIT License
 *
 * Copyright (c) 2025  Yurii Yakubin (yurii.yakubin@gmail.com)
...
class ProjectContext {
    ...
    constructor() {
        ...
        this._subdirAlias = {};
        this._builtinScripts = _core_BuiltinScripts__WEBPACK_IMPORTED_MODULE_18__["default"];
        this._subdirList = [];
    }
    static create() {
    ...
    addSubdirectoryAlias(variableMap, src, dest) {
        const srcPath = _utils_Locator__WEBPACK_IMPORTED_MODULE_2__.Locator.create(_Scope__WEBPACK_IMPORTED_MODULE_12__.ScopeHelper.get(variableMap, "SOURCE_DIR").resolve(src));
        const destPath = (dest === null) ? null : _utils_Locator__WEBPACK_IMPORTED_MODULE_2__.Locator.create(_Scope__WEBPACK_IMPORTED_MODULE_12__.ScopeHelper.get(variableMap, "SOURCE_DIR").resolve(dest));
