...
class BuildContext {
    ...
    async loadBuildTree() {
        ...
        if (this._configArg) {
            ...
            const userConfigPath = this._workDir.join(_Constants__WEBPACK_IMPORTED_MODULE_10__.USER_CONFIG);
