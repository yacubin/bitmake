...
/* harmony import */ var _utils_UrlScheme__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/utils/UrlScheme */ "./src/utils/UrlScheme.ts");
...
/* harmony import */ var _utils_JSValue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @/utils/JSValue */ "./src/utils/JSValue.ts");
/* harmony import */ var _utils_Locator__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @/utils/Locator */ "./src/utils/Locator.ts");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @/actions */ "./src/actions/index.ts");
/*
 * MIT License
 *
 * Copyright (c) 2025  Yurii Yakubin (yurii.yakubin@gmail.com)
...
const logger = _logger__WEBPACK_IMPORTED_MODULE_12__.Logger.create("file:///mnt/c/opt/work/source/darkit-sdk/external/bitmake/src/commands/build.ts");
;
;
class BmkRoot {
    _children = new Map;
    ...
    static create(buildType, sourceRoot, binaryRoot, config) {
        ...
        for (const [name, originConfig] of Object.entries(config)) {
            const workConfig = (0,_utils_Primitives__WEBPACK_IMPORTED_MODULE_6__.deepCopy)(originConfig);
...
async function resolveEnvironment(environment) {
    if (typeof environment !== "string")
        return environment;
    const envFile = _utils_Locator__WEBPACK_IMPORTED_MODULE_14__.Locator.create(environment);
    return (0,_utils_JSValue__WEBPACK_IMPORTED_MODULE_13__.loadJSValue)(envFile);
}
...
function makeBuildConfig(bmkRoot) {
    ...
    for (const [key, entry] of Object.entries(rootConfig)) {
        if (entry && typeof entry === "object" && entry.action) {
            ...
            if (entry.sourceUrl) {
                if (entry.sourceUrl.startsWith(_utils_UrlScheme__WEBPACK_IMPORTED_MODULE_9__.IMPORT_SCHEME)) {
                    const filename = (0,_utils_Module__WEBPACK_IMPORTED_MODULE_10__.requireResolve)(entry.sourceUrl.slice(_utils_UrlScheme__WEBPACK_IMPORTED_MODULE_9__.IMPORT_SCHEME.length));
                    entry.sourceDir = _utils_Path__WEBPACK_IMPORTED_MODULE_2__.Path.dirname(filename);
                }
                else {
...
class BuildContext {
    ...
    async doExtractArchive(environment, config, settings) {
        ...
        if (!await (0,_utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.directoryExists)(config.archiveDir)) {
            await _utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.FileSystem.mkdir(config.archiveDir, { recursive: true });
        }
        if (!await (0,_utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.directoryExists)(config.tempDir)) {
            await _utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.FileSystem.mkdir(config.tempDir, { recursive: true });
        }
        ...
        if (downloadUrls[config.sourceUrl])
            ...
            await (0,_utils_HttpRequest__WEBPACK_IMPORTED_MODULE_11__.downloadFile)(config.sourceUrl, arcFile, { attempts: _Constants__WEBPACK_IMPORTED_MODULE_7__.REQUEST_ATTEMPTS });
        ...
        if (extractFiles[arcFile]) {
            ...
            const extractList = await _utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.FileSystem.readdir(extractDir);
            if (extractList.length === 1) {
                ...
                if (!await (0,_utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.directoryExists)(extractDir)) {
                    await _utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.FileSystem.rm(extractDir, { recursive: true });
            ...
            if (await (0,_utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.directoryExists)(config.extractDir)) {
                ...
                await _utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.FileSystem.rm(config.extractDir, { recursive: true });
            }
            else {
                ...
                if (!await (0,_utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.directoryExists)(parentDir)) {
                    await _utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.FileSystem.mkdir(parentDir, { recursive: true });
                }
            }
            await _utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.FileSystem.rename(extractDir, config.extractDir);
    ...
    async doTargetBuild(gconfig, environment, config, settings) {
        ...
        if (Array.isArray(config.action)) {
            ...
            if (!await (0,_utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.directoryExists)(config.binaryDir)) {
                await _utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.FileSystem.mkdir(config.binaryDir, { recursive: true });
            }
            if (_actions__WEBPACK_IMPORTED_MODULE_15__["default"][config.action]) {
                config.description && logger.notice(config.description);
                await _actions__WEBPACK_IMPORTED_MODULE_15__["default"][config.action](config, environment, settings);
            }
        }
    ...
    async loadTreeConfig() {
        ...
        if (this._configArg) {
            ...
            configPath = this._workDir.join(_Constants__WEBPACK_IMPORTED_MODULE_7__.USER_CONFIG);
            if (!await (0,_utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.fileExists)(configPath)) {
        ...
        const { default: configModule } = await (0,_utils_Module__WEBPACK_IMPORTED_MODULE_10__.importModule)(configPath.toURLString());
    ...
    async run() {
        ...
        if (this._buildTreeConfig.RECIPE_CONTENT_FILE) {
            ...
            await (0,_utils_FileSystem__WEBPACK_IMPORTED_MODULE_4__.saveIfDifferent)(this._buildTreeConfig.RECIPE_CONTENT_FILE, recipeJson);
        }
        const settingsFilename = _utils_Path__WEBPACK_IMPORTED_MODULE_2__.Path.resolve(this._buildTreeConfig.binaryRoot, _Constants__WEBPACK_IMPORTED_MODULE_7__.BUILD_SETTINGS_FILE);
        ...
        for (const [key, entry] of Object.entries(this._buildTreeConfig)) {
            if (entry && typeof entry === "object" && entry.action && !entry.disabled) {
                ...
                if (entry.rebuild || !completed) {
                    ...
                    if (entry.sourceUrl && !entry.sourceUrl.startsWith(_utils_UrlScheme__WEBPACK_IMPORTED_MODULE_9__.IMPORT_SCHEME)) {
...
/* harmony import */ var _commands_webui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/commands/webui */ "./src/commands/webui.ts");
/*
 * MIT License
 *
 * Copyright (c) 2025  Yurii Yakubin (yurii.yakubin@gmail.com)
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
    ...
    webui: _commands_webui__WEBPACK_IMPORTED_MODULE_2__["default"],
});
...
/* harmony import */ var _server_WebServer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/server/WebServer */ "./src/server/WebServer.ts");
/*
 * MIT License
 *
 * Copyright (c) 2025  Yurii Yakubin (yurii.yakubin@gmail.com)
...
const logger = _logger__WEBPACK_IMPORTED_MODULE_5__.Logger.create("file:///mnt/c/opt/work/source/darkit-sdk/external/bitmake/src/commands/webui.ts");
...
;
function registerJsonHandler(server, path, callback) {
...
function registerHtmlData(server, path, data) {
    const executer = new StaticDataExecuter(data);
    executer.setContentType("text/html");
    server.registerRequest(path, (req, res) => executer.requestHandler(req, res));
}
function registerFilename(server, path, filename) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (options) => {
    ...
    const server = _server_WebServer__WEBPACK_IMPORTED_MODULE_7__.WebServer.create("localhost", (0,_utils_Random__WEBPACK_IMPORTED_MODULE_4__.randInt)(49152, 65535));
  ...
  `);
    const dirUrl = node_url__WEBPACK_IMPORTED_MODULE_1___default().fileURLToPath((0,_utils_Module__WEBPACK_IMPORTED_MODULE_6__.currentScriptURL)());
    const filename = node_path__WEBPACK_IMPORTED_MODULE_2___default().join(node_path__WEBPACK_IMPORTED_MODULE_2___default().dirname(dirUrl), "script.js");
    ...
    node_child_process__WEBPACK_IMPORTED_MODULE_3___default().exec(`${startCommand} ${server.rootURL}`, (error, stdout, stderr) => {
...
/* harmony import */ var _utils_Random__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/utils/Random */ "./src/utils/Random.ts");
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/logger */ "./src/logger/index.ts");
/*
 * MIT License
 *
...
const logger = _logger__WEBPACK_IMPORTED_MODULE_3__.Logger.create("file:///mnt/c/opt/work/source/darkit-sdk/external/bitmake/src/server/WebServer.ts");
...
(function (FrameType) {
    ...
    FrameType[FrameType["ConnectionClose"] = 8] = "ConnectionClose";
...
var Frame;
(function (Frame) {
    function fromString(str, hasMask) {
        ...
        if (hasMask) {
            mask = [
                (0,_utils_Random__WEBPACK_IMPORTED_MODULE_2__.randUint8)(),
                (0,_utils_Random__WEBPACK_IMPORTED_MODULE_2__.randUint8)(),
                (0,_utils_Random__WEBPACK_IMPORTED_MODULE_2__.randUint8)(),
                (0,_utils_Random__WEBPACK_IMPORTED_MODULE_2__.randUint8)(),
            ];
...
class WebServer {
    _httpServer;
    _rootURL;
    _requestListeners = new Map;
    _socketListeners = new Map;
    _wsList = [];
    constructor(hostname, port) {
        this._rootURL = new URL(`http://${hostname}:${port}`);
        this._httpServer = node_http__WEBPACK_IMPORTED_MODULE_0___default().createServer((req, res) => this.onServerRequest(req, res));
    ...
    onServerUpgrade(req, socket, head) {
        ...
        const hash = node_crypto__WEBPACK_IMPORTED_MODULE_1___default().createHash("sha1");
    ...
    registerRequest(path, listener) {
        this._requestListeners.set(path, listener);
    }
    registerSocket(path, listener) {
...
const logger = _logger__WEBPACK_IMPORTED_MODULE_5__.Logger.create("file:///mnt/c/opt/work/source/darkit-sdk/external/bitmake/src/utils/HttpRequest.ts");
;
class BufferBuilder {
    _chunks = [];
    append(chunk) {
...
function httpRequest(url, options, callback) {
    if (url.startsWith(_utils_UrlScheme__WEBPACK_IMPORTED_MODULE_4__.HTTPS_SCHEME))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   randBuffer: () => (/* binding */ randBuffer),
/* harmony export */   randCIdentifer: () => (/* binding */ randCIdentifer),
/* harmony export */   randInt: () => (/* binding */ randInt),
/* harmony export */   randUint8: () => (/* binding */ randUint8)
/* harmony export */ });
/*
 * MIT License
 *
...
function randBuffer(buffer, offset, length) {
