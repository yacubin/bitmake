...
/* harmony import */ var _core_TargetLink__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @/core/TargetLink */ "./src/core/TargetLink.ts");
/*
 * MIT License
 *
 * Copyright (c) 2025  Yurii Yakubin (yurii.yakubin@gmail.com)
...
class MakeContext extends GeneralContext {
    ...
    target(name) {
        ...
        if (!target) {
            target = _core_Target__WEBPACK_IMPORTED_MODULE_6__.PostTarget.create(this._scope, name);
    ...
    addObjectLibrary(name, ...sources) {
        ...
        const target = _core_Target__WEBPACK_IMPORTED_MODULE_6__.ObjectLibrary.create(this._scope, name);
    ...
    addStaticLibrary(name, ...sources) {
        if (this._targets.has(name))
            throw new Error(`Target "${name}" exists`);
        const target = _core_Target__WEBPACK_IMPORTED_MODULE_6__.StaticLibrary.create(this._scope, name);
        this._targets.set(name, target);
        target.addSources(...sources);
        return target;
    }
    addSharedLibrary(name, ...sources) {
        if (this._targets.has(name))
            throw new Error(`Target "${name}" exists`);
        const target = _core_Target__WEBPACK_IMPORTED_MODULE_6__.SharedLibrary.create(this._scope, name);
        this._targets.set(name, target);
        target.addSources(...sources);
        return target;
    }
    addExecutable(name, ...sources) {
        if (this._targets.has(name))
            throw new Error(`Target "${name}" exists`);
        const target = _core_Target__WEBPACK_IMPORTED_MODULE_6__.Executable.create(this._scope, name);
        this._targets.set(name, target);
        target.addSources(...sources);
        return target;
    }
    ...
    install(value, params) {
        ...
        for (const it of [value].flat()) {
            const iter = (it instanceof _core_MakeInterfaces__WEBPACK_IMPORTED_MODULE_0__.InterfaceTarget) ? _core_TargetLink__WEBPACK_IMPORTED_MODULE_11__.TargetLink.create(it.targetName) : it;
...
/* harmony export */ });
/* harmony import */ var _core_TargetLink__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/core/TargetLink */ "./src/core/TargetLink.ts");
...
class InstallEntity {
    ...
    constructor(scope, value, params) {
        ...
        else if (!(value instanceof _core_TargetLink__WEBPACK_IMPORTED_MODULE_0__.TargetLink)) {
...
/* harmony import */ var _core_UserMakeContext__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @/core/UserMakeContext */ "./src/core/UserMakeContext.ts");
/* harmony import */ var _core_LocalMakeContext__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @/core/LocalMakeContext */ "./src/core/LocalMakeContext.ts");
...
/* harmony import */ var _core_TargetLink__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @/core/TargetLink */ "./src/core/TargetLink.ts");
...
/* harmony import */ var _core_TargetFile__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @/core/TargetFile */ "./src/core/TargetFile.ts");
...
function resolveInstance(project, o) {
    ...
    if (o instanceof _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_4__.AbsolutePath)
        return o.toString();
    if (o instanceof _core_TargetFile__WEBPACK_IMPORTED_MODULE_18__.TargetFile) {
...
class ProjectContext {
    ...
    async doSubdirectory() {
        ...
        for (;;) {
            ...
            if (!await this.prepearScriptFile(variableMap))
                continue;
            const ctx = new _core_LocalMakeContext__WEBPACK_IMPORTED_MODULE_11__.LocalMakeContext(variableMap, this);
            contextList.push(ctx);
            const mk = _core_UserMakeContext__WEBPACK_IMPORTED_MODULE_10__.UserMakeContext.create(ctx, variableMap);
            const cwdSave = process.cwd();
    ...
    createGoals(scope) {
        ...
        for (const iter of this._installList) {
            ...
            else if (iter.VALUE instanceof _core_TargetLink__WEBPACK_IMPORTED_MODULE_15__.TargetLink) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TargetLink: () => (/* binding */ TargetLink)
/* harmony export */ });
/* harmony import */ var _core_SimpleObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/core/SimpleObject */ "./src/core/SimpleObject.ts");
/*
 * MIT License
...
class TargetLink {
    ...
    static fromJSON(object) {
        return TargetLink.create(object.targetName);
    }
    get targetName() {
        return this[NAME];
    }
...
;
_core_SimpleObject__WEBPACK_IMPORTED_MODULE_0__.SimpleObject.registerInstanceCreator(TargetLink.name, TargetLink.fromJSON);
