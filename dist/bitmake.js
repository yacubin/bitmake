...
class LocalMakeContext extends _core_BaseContext__WEBPACK_IMPORTED_MODULE_0__.MakeContext {
    ...
    addCustomScript(script, params) {
        const newVariableMap = _core_Scope__WEBPACK_IMPORTED_MODULE_2__.ScopeHelper.cloneVariableMap(this._scope);
        _core_Scope__WEBPACK_IMPORTED_MODULE_2__.ScopeHelper.extendVariableMapByValues(newVariableMap, _Constants__WEBPACK_IMPORTED_MODULE_4__.CUSTOM_VARIABLE_GROUP, params);
        _core_Scope__WEBPACK_IMPORTED_MODULE_2__.ScopeHelper.set(newVariableMap, "SCRIPT_MODULE", script);
...
class ProjectContext {
    ...
    createGoals(scope) {
        ...
        for (const iter of this._installList) {
            ...
            else if (iter.VALUE instanceof _core_Target__WEBPACK_IMPORTED_MODULE_12__.PostTarget) {
