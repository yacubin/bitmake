...
/* harmony import */ var _core_TargetName__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @/core/TargetName */ "./src/core/TargetName.ts");
    ...
    createGoals(scope) {
        ...
        for (const [name, target] of this[TARGETS].ENTRIES) {
            ...
            for (const s of target.getSourceFileList()) {
                ...
                const output = _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_4__.AbsolutePath.create(target.binaryDir.join(relativeObject));
        ...
        for (const iter of this._installList) {
            ...
            else if (iter.VALUE instanceof _core_TargetName__WEBPACK_IMPORTED_MODULE_15__.TargetName) {
...
/* harmony import */ var _core_TargetName__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/core/TargetName */ "./src/core/TargetName.ts");
/* harmony import */ var _core_TargetFile__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/core/TargetFile */ "./src/core/TargetFile.ts");
...
function normalizeIncludes(baseDir, ...includes) {
    ...
    for (const iter of includes.flat()) {
        if (iter instanceof _core_TargetIncludes__WEBPACK_IMPORTED_MODULE_5__.TargetIncludes)
            result.push(iter);
        else if (typeof iter === "string")
            result.push(_core_AbsolutePath__WEBPACK_IMPORTED_MODULE_7__.AbsolutePath.create(baseDir.resolve(iter)));
        else if (iter instanceof _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_7__.AbsolutePath)
            result.push(_core_AbsolutePath__WEBPACK_IMPORTED_MODULE_7__.AbsolutePath.create(iter));
        else
...
function createSources(scope, source) {
    if (source instanceof _core_TargetObjects__WEBPACK_IMPORTED_MODULE_6__.TargetObjects || source instanceof _core_SourceFile__WEBPACK_IMPORTED_MODULE_1__.SourceFile)
        return source;
    if (typeof source === "string" || _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_7__.AbsolutePath.isAbsolute(source)) {
...
function makeTargetCommand(_command, _args) {
    ...
    if (typeof _command === "string")
        command = _command;
    else if (_command instanceof _core_TargetFile__WEBPACK_IMPORTED_MODULE_4__.TargetFile)
        command = _command;
    else if (_command instanceof _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_7__.AbsolutePath)
        command = _command;
    else
    ...
    for (const iter of _args) {
        if (typeof iter === "string")
            args.push(iter);
        else if (iter instanceof _core_TargetFile__WEBPACK_IMPORTED_MODULE_4__.TargetFile)
            args.push(iter);
        else if (iter instanceof _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_7__.AbsolutePath)
            args.push(iter);
        else
...
class BaseTarget extends _core_MakeInterfaces__WEBPACK_IMPORTED_MODULE_0__.InterfaceTarget {
    ...
    constructor(variableMap, options) {
        ...
        if ([_Constants__WEBPACK_IMPORTED_MODULE_9__.ALL_TARGET, _Constants__WEBPACK_IMPORTED_MODULE_9__.INSTALL_TARGET].includes(name))
            throw new Error(`Target "${name}" is reserved name`);
        const variables = _core_Scope__WEBPACK_IMPORTED_MODULE_8__.ScopeHelper.createVariableValues(variableMap, _Constants__WEBPACK_IMPORTED_MODULE_9__.SYSTEM_VARIABLE_GROUP);
    ...
    get includes() {
        return _core_TargetIncludes__WEBPACK_IMPORTED_MODULE_5__.TargetIncludes.create(this._name);
    }
    get objects() {
        return _core_TargetObjects__WEBPACK_IMPORTED_MODULE_6__.TargetObjects.create(this._name);
    }
    get targetFile() {
        return _core_TargetFile__WEBPACK_IMPORTED_MODULE_4__.TargetFile.create(this._name);
    }
    getIncludes() {
    ...
    addLibrariesImpl(publicOnly, ...libraries) {
        for (const iter of libraries.flat())
            this._libraries.push({ publicOnly, value: _core_TargetName__WEBPACK_IMPORTED_MODULE_3__.TargetName.create(iter.targetName) });
    }
    getHeaders() {
        const result = new Array;
    ...
    getTargetObjectsList() {
        return this._sources.map(i => i.value).filter(i => i instanceof _core_TargetObjects__WEBPACK_IMPORTED_MODULE_6__.TargetObjects);
    }
