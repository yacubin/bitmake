...
function makeTargetCommand(_command, _args) {
    ...
    if (typeof _command === "string")
        command = _command;
    else if (_command instanceof _core_TargetStruct__WEBPACK_IMPORTED_MODULE_6__.LiveString)
        command = _command;
    else if (_command instanceof _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_4__.AbsolutePath)
    ...
    for (const iter of _args) {
        if (typeof iter === "string")
            args.push(iter);
        else if (iter instanceof _core_TargetStruct__WEBPACK_IMPORTED_MODULE_6__.LiveString)
            args.push(iter);
        else if (iter instanceof _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_4__.AbsolutePath)
...
/* harmony export */ });
/* harmony import */ var _core_InterfaceObjects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/core/InterfaceObjects */ "./src/core/InterfaceObjects.ts");
/* harmony import */ var _core_Target__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/core/Target */ "./src/core/Target.ts");
...
class TargetStruct {
    ...
    getInterfaceObjectsList() {
        return this._sources.items.map(i => i.value).filter(i => i instanceof _core_InterfaceObjects__WEBPACK_IMPORTED_MODULE_0__.InterfaceObjects);
    }
    getHeaders() {
        const result = new Array;
    ...
    addLibrary(origin, publicOnly, value) {
        this._libraries.addItem(origin, publicOnly, _core_Target__WEBPACK_IMPORTED_MODULE_1__.UserIndirectTarget.ensureInstance(value));
    }
    getLibraries() {
