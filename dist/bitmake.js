...
class LocalMakeContext {
    ...
    target(name) {
        ...
        if (!target) {
            target = _core_Target__WEBPACK_IMPORTED_MODULE_2__.PostTarget.create(this._scope, name);
    ...
    addObjectLibrary(name, ...sources) {
        ...
        const target = _core_Target__WEBPACK_IMPORTED_MODULE_2__.ObjectLibrary.create(this._scope, name);
    ...
    addStaticLibrary(name, ...sources) {
        if (this._targets.has(name))
            throw new Error(`Target "${name}" exists`);
        const target = _core_Target__WEBPACK_IMPORTED_MODULE_2__.StaticLibrary.create(this._scope, name);
        this._targets.set(name, target);
        target.addSources(...sources);
        return target;
    }
    addSharedLibrary(name, ...sources) {
        if (this._targets.has(name))
            throw new Error(`Target "${name}" exists`);
        const target = _core_Target__WEBPACK_IMPORTED_MODULE_2__.SharedLibrary.create(this._scope, name);
        this._targets.set(name, target);
        target.addSources(...sources);
        return target;
    }
    addExecutable(name, ...sources) {
        if (this._targets.has(name))
            throw new Error(`Target "${name}" exists`);
        const target = _core_Target__WEBPACK_IMPORTED_MODULE_2__.Executable.create(this._scope, name);
        this._targets.set(name, target);
        target.addSources(...sources);
        return target;
    }
...
;
class PostTarget extends AbstractTarget {
    _prefix;
    _outputName;
    _suffix;
