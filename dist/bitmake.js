...
function createSources(scope, source) {
    if (source instanceof _core_TargetObjects__WEBPACK_IMPORTED_MODULE_4__.TargetObjects || source instanceof _core_SourceFile__WEBPACK_IMPORTED_MODULE_0__.SourceFile)
        return source;
...
class TargetCollection {
    ...
    __getAllIncludes(includes, targetSet, list) {
        for (const iter of list) {
            if (iter instanceof _core_TargetIncludes__WEBPACK_IMPORTED_MODULE_0__.TargetIncludes || iter instanceof _core_Target__WEBPACK_IMPORTED_MODULE_1__.UserIndirectTarget) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TargetFileStruct: () => (/* binding */ TargetFileStruct),
/* harmony export */   TargetStruct: () => (/* binding */ TargetStruct),
/* harmony export */   TargetType: () => (/* binding */ TargetType)
/* harmony export */ });
/* harmony import */ var _core_TargetObjects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/core/TargetObjects */ "./src/core/TargetObjects.ts");
/* harmony import */ var _core_Target__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/core/Target */ "./src/core/Target.ts");
/* harmony import */ var _core_SourceFile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/core/SourceFile */ "./src/core/SourceFile.ts");
/*
 * MIT License
 *
 * Copyright (c) 2025  Yurii Yakubin (yurii.yakubin@gmail.com)
...
class TargetStruct {
    ...
    addCompileOption(publicOnly, value) {
    ...
    addLinkOption(publicOnly, value) {
    ...
    addSource(publicOnly, value) {
        this._sources.addItem(publicOnly, value);
    }
    getSourceFiles() {
        return this._sources.items.map(i => i.value).filter(i => i instanceof _core_SourceFile__WEBPACK_IMPORTED_MODULE_2__.SourceFile);
    }
    getTargetObjectsList() {
        return this._sources.items.map(i => i.value).filter(i => i instanceof _core_TargetObjects__WEBPACK_IMPORTED_MODULE_0__.TargetObjects);
    }
    getHeaders() {
        const result = new Array;
        for (const iter of this._sources.items) {
            if (iter.value instanceof _core_SourceFile__WEBPACK_IMPORTED_MODULE_2__.SourceFile && iter.value.HEADER_FILE_ONLY)
                result.push(iter.value);
        }
        return result;
    }
    addLibrary(publicOnly, value) {
        this._libraries.addItem(publicOnly, _core_Target__WEBPACK_IMPORTED_MODULE_1__.UserIndirectTarget.ensureInstance(value));
    }
    getLibraries() {
