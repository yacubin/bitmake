...
const logger = _logger__WEBPACK_IMPORTED_MODULE_5__.Logger.create("file:///mnt/c/opt/work/source/darkit-sdk/external/bitmake/src/server/MainNode.ts");
class MainNode {
    _project;
    constructor(project) {
    ...
    async startMakeScript(params) {
        ...
        if (!await this._project.prepearScriptFile(variableMap))
            return;
        const client = new _server_MakeClient__WEBPACK_IMPORTED_MODULE_4__.MakeClient(this._project);
        const cwdSave = process.cwd();
        const scriptDir = _core_Scope__WEBPACK_IMPORTED_MODULE_2__.ScopeHelper.get(variableMap, "SCRIPT_DIR");
...
/* harmony import */ var _server_MainNode__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/server/MainNode */ "./src/server/MainNode.ts");
/* harmony import */ var _utils_Module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/utils/Module */ "./src/utils/Module.ts");
/* harmony import */ var _server_MemoryTransport__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/server/MemoryTransport */ "./src/server/MemoryTransport.ts");
/* harmony import */ var _server_WorkerSender__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/server/WorkerSender */ "./src/server/WorkerSender.ts");
/* harmony import */ var _core_Scope__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/core/Scope */ "./src/core/Scope.ts");
/* harmony import */ var _server_Transport__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/server/Transport */ "./src/server/Transport.ts");
...
const logger = _logger__WEBPACK_IMPORTED_MODULE_9__.Logger.create("file:///mnt/c/opt/work/source/darkit-sdk/external/bitmake/src/server/MakeClient.ts");
;
class MakeClient {
    _jsonRpcServer;
    _worker;
    ...
    ;
    constructor(project) {
        this._worker = new node_worker_threads__WEBPACK_IMPORTED_MODULE_0__.Worker((0,_utils_Module__WEBPACK_IMPORTED_MODULE_3__.currentScriptURL)());
        ...
        const mainNode = new _server_MainNode__WEBPACK_IMPORTED_MODULE_2__.MainNode(project);
        this._jsonRpcServer = new _server_JsonRpcServer__WEBPACK_IMPORTED_MODULE_1__.JsonRpcServer;
        this._jsonRpcServer.registerCallback(_server_RemoteMethods__WEBPACK_IMPORTED_MODULE_8__.MAINNODE_EXECUTESCRIPT, params => mainNode.executeScript(params));
        this._jsonRpcServer.registerCallback(_server_RemoteMethods__WEBPACK_IMPORTED_MODULE_8__.MAINNODE_LOADJSON, params => mainNode.loadJSON(params));
        this._jsonRpcServer.registerCallback(_server_RemoteMethods__WEBPACK_IMPORTED_MODULE_8__.MAINNODE_STARTMAKESCRIPT, params => mainNode.startMakeScript(params));
    }
    async startMakeScript(variableMap) {
        const id = this._id++;
        const result = new Promise((resolve, reject) => {
            this._waitResponseMap.set(id, { resolve, reject });
        });
        this._worker.postMessage({
            jsonrpc: _server_Transport__WEBPACK_IMPORTED_MODULE_7__.JSONRPC_VERSION,
            method: _server_RemoteMethods__WEBPACK_IMPORTED_MODULE_8__.WORKERNODE_STARTMAKESCRIPT,
            params: _core_Scope__WEBPACK_IMPORTED_MODULE_6__.ScopeHelper.toJSON(variableMap),
            id,
        });
        return result;
    }
    onWorkerMessage(message) {
        if (message instanceof SharedArrayBuffer) {
            const mt = new _server_MemoryTransport__WEBPACK_IMPORTED_MODULE_4__.MemoryMessageSender(message);
            this._jsonRpcServer.emitMessage(mt, mt.readMessage());
        }
        else {
            const sender = new _server_WorkerSender__WEBPACK_IMPORTED_MODULE_5__.WorkerSender(this._worker);
...
const logger = _logger__WEBPACK_IMPORTED_MODULE_4__.Logger.create("file:///mnt/c/opt/work/source/darkit-sdk/external/bitmake/src/server/MakeServer.ts");
...
class MakeServer {
    ...
    createClient() {
        ...
        const client = new _server_MakeClient__WEBPACK_IMPORTED_MODULE_3__.MakeClient(this._project);
    ...
    async start() {
        ...
        const variableMap = (0,_core_BaseContext__WEBPACK_IMPORTED_MODULE_1__.createVariableMapForDirectory)(this._rootVariableMap, sourceDir, binaryDir);
        if (!await this._project.prepearScriptFile(variableMap))
            throw Error("Can't prepear ScriptFile");
        const client = this.createClient();
        const cwdSave = process.cwd();
        const scriptDir = _core_Scope__WEBPACK_IMPORTED_MODULE_2__.ScopeHelper.get(this._rootVariableMap, "SCRIPT_DIR");
        process.chdir(scriptDir.toString());
        await client.startMakeScript(variableMap);
        process.chdir(cwdSave);
        this.onConfigureEnd();
