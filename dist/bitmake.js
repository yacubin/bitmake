...
class AbstractTarget {
    ...
    getInterfaceObjectsList() {
        return this._sources.map(i => i.value).filter(i => i instanceof _core_InterfaceObjects__WEBPACK_IMPORTED_MODULE_3__.InterfaceObjects);
    }
...
;
class UserIndirectTarget extends AbstractTarget {
    _prefix;
    _outputName;
    _suffix;
...
;
class BaseTarget extends AbstractTarget {
    _prefix = "";
    _outputName;
    _suffix = "";
    _positionIndependentCode;
