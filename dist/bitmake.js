...
/* harmony import */ var _core_TargetName__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/core/TargetName */ "./src/core/TargetName.ts");
/* harmony import */ var _core_SourceFile__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/core/SourceFile */ "./src/core/SourceFile.ts");
/* harmony import */ var _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/core/AbsolutePath */ "./src/core/AbsolutePath.ts");
/* harmony import */ var _core_Target__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/core/Target */ "./src/core/Target.ts");
/* harmony import */ var _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @/core/SimpleObject */ "./src/core/SimpleObject.ts");
/*
 * MIT License
 *
 * Copyright (c) 2025  Yurii Yakubin (yurii.yakubin@gmail.com)
...
function runScriptInit() {
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_CustomScript__WEBPACK_IMPORTED_MODULE_0__.PostCustomScript.name, _core_CustomScript__WEBPACK_IMPORTED_MODULE_0__.PostCustomScript.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_FileInstallationTask__WEBPACK_IMPORTED_MODULE_1__.FileInstallationTask.name, _core_FileInstallationTask__WEBPACK_IMPORTED_MODULE_1__.FileInstallationTask.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_SpawnSyncTask__WEBPACK_IMPORTED_MODULE_2__.SpawnSyncTask.name, _core_SpawnSyncTask__WEBPACK_IMPORTED_MODULE_2__.SpawnSyncTask.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_TargetFile__WEBPACK_IMPORTED_MODULE_3__.TargetFile.name, _core_TargetFile__WEBPACK_IMPORTED_MODULE_3__.TargetFile.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_TargetIncludes__WEBPACK_IMPORTED_MODULE_4__.TargetIncludes.name, _core_TargetIncludes__WEBPACK_IMPORTED_MODULE_4__.TargetIncludes.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_TargetObjects__WEBPACK_IMPORTED_MODULE_5__.TargetObjects.name, _core_TargetObjects__WEBPACK_IMPORTED_MODULE_5__.TargetObjects.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_TargetName__WEBPACK_IMPORTED_MODULE_6__.TargetName.name, _core_TargetName__WEBPACK_IMPORTED_MODULE_6__.TargetName.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_SourceFile__WEBPACK_IMPORTED_MODULE_7__.SourceFile.name, _core_SourceFile__WEBPACK_IMPORTED_MODULE_7__.SourceFile.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_AbsolutePath__WEBPACK_IMPORTED_MODULE_8__.DirPath.name, _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_8__.DirPath.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_AbsolutePath__WEBPACK_IMPORTED_MODULE_8__.FilePath.name, _core_AbsolutePath__WEBPACK_IMPORTED_MODULE_8__.FilePath.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_Target__WEBPACK_IMPORTED_MODULE_9__.PostTarget.name, _core_Target__WEBPACK_IMPORTED_MODULE_9__.PostTarget.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_Target__WEBPACK_IMPORTED_MODULE_9__.ObjectLibrary.name, _core_Target__WEBPACK_IMPORTED_MODULE_9__.ObjectLibrary.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_Target__WEBPACK_IMPORTED_MODULE_9__.StaticLibrary.name, _core_Target__WEBPACK_IMPORTED_MODULE_9__.StaticLibrary.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_Target__WEBPACK_IMPORTED_MODULE_9__.SharedLibrary.name, _core_Target__WEBPACK_IMPORTED_MODULE_9__.SharedLibrary.fromJSON);
    _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.registerParser(_core_Target__WEBPACK_IMPORTED_MODULE_9__.Executable.name, _core_Target__WEBPACK_IMPORTED_MODULE_9__.Executable.fromJSON);
}
...
class MakeServer {
    ...
    async runMakeScript(variableMap) {
        ...
        process.chdir(cwdSave);
        const mainTargets = await client.request(_server_RemoteMethods__WEBPACK_IMPORTED_MODULE_8__.WORKERNODE_MAINTARGETS, null);
        const _mainTargets = _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.fromJSON(mainTargets);
        const postTargets = await client.request(_server_RemoteMethods__WEBPACK_IMPORTED_MODULE_8__.WORKERNODE_POSTTARGETS, null);
        const _postTargets = _core_SimpleObject__WEBPACK_IMPORTED_MODULE_10__.SimpleObject.fromJSON(postTargets);
        return true;
    }
    async start() {
